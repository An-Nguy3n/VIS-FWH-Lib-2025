...
void load_checkpoint_PolyMethod(int64_t **&current, string folder_save, int64_t &num_opr_per_fml, string lib_abs_path){
    string db_path = folder_save + "/f.db";
    string command = "python " + lib_abs_path + "/PySources/load_checkpoint_PolyMethod.py " + db_path;
...
void read_config_HomoPolyMethod(string config_path, vector<string> &keys, vector<string> &values){
