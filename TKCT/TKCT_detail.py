...
def get_info(vis: Base, ct_: str, method: str, sum_rank: np.ndarray, sum_rank_ni: np.ndarray, eval_method="classic"):
...
def get_dfs(vis: Base, list_ct, method: str, eval_method: str):
    ...
    for ct_ in tqdm(list_ct):
        info = get_info(vis, ct_, method, sum_rank, sum_rank_ni, eval_method)
